 ...
 *
 * These unit tests validate that the candidate hasn't change key interfaces before submission. If
 * this class failes to compile or asserts at runtime, the submission will not be scored.
 *
 * To avoid creating a submission that can not be graded, don't change this file and be sure to run
 * mvn test before submission.
 */
public class DoNotChangeTest {
  ...
  private void validateInterfaceWeatherCollector() {
    ...
    Response updateWeatherResp =
        collector.updateWeather((String) null, (String) null, (String) null);
  ...
  /**
   * The compile time interface validator for WeatherQueryEndpoint. This method will NEVER been
   * called, but must compile.
   */
  ...
  public void testPomFile() throws Exception {
    ...
    Document d = DocumentBuilderFactory.newInstance().newDocumentBuilder()
        .parse(new FileInputStream(pomFile));
